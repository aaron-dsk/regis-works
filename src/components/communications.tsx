      ...
      <div className="flex-1 flex flex-col overflow-hidden bg-gray-50 dark:bg-gray-900">
        ...
        <div className="flex-1 overflow-y-auto p-4">
          <div className="bg-white dark:bg-gray-800 rounded-lg p-4 shadow mb-4">
            <p className="text-sm">
              Hello! I'm here to assist you with understanding and navigating the constitutions of the
              Republic of Argentina and the Province of Misiones. If you have any questions or need
              clarification on any article or section, I'll be happy to help. How can I assist you today?
            </p>
          </div>
        </div>
